public class GradeConstants {
    ...
    static public double MIN_SCORE = 0;

    static public double TEACHER_WEIGHT = 0.05;
    static public double PARTICIPATION_WEIGHT = 0.05;
    static public double LAB_WEIGHT = 0.4;
    static public double EXAM_WEIGHT = 0.2;
    static public double PROJECT_WEIGHT = 0.3;
